...
#model_name, model_status = "ModeloPuntuacionVinos", "Staging"
model_name, model_status = "ModeloPuntuacionVinos", "Production"
model = mlflow.pyfunc.load_model(model_uri=f"models:/{model_name}/{model_status}")
